                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Avtar image" width="33">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Adam Baldwin
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="Avtar image" width="33">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Peter Wallace
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="Avtar image" width="33">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Jacob Dunn
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="Avtar image" width="33">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Terry Adams
                                                </div>
