...
@section('style')
    <!-- third party css -->
    <link href="{{ asset('assets/css/vendor/britecharts.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
    <!-- Start Content-->
...
@section('script')
    <!-- third party:js -->
    <script src="{{ asset('assets/js/vendor/d3.min.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/britecharts.min.js') }}"></script>
    <!-- third party end -->
