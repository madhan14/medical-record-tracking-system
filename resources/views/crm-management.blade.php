            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle avatar-sm" src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Avtar image">
                            </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle avatar-sm" src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="Avtar image">
                            </div>
                            <div class="flex-grow-1 ms-2">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle avatar-sm" src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="Avtar image">
                            </div>
                            <div class="flex-grow-1 ms-2">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle avatar-sm" src="{{ asset('assets/images/users/avatar-5.jpg') }}" alt="Avtar image">
                            </div>
                            <div class="flex-grow-1 ms-2">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle avatar-sm" src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt="Avtar image">
                            </div>
                            <div class="flex-grow-1 ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Avtar image" width="31">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Adam Baldwin
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="Avtar image" width="31">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Peter Wallace
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="Avtar image" width="31">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Jacob Dunn
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="Avtar image" width="31">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Terry Adams
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-5.jpg') }}" alt="Avtar image" width="31">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    Jason Stovall
                                                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img class="rounded-circle" src="{{ asset('assets/images/users/avatar-4.jpg') }}" height="40" alt="Avtar image">
                            </div>
                            <div class="flex-grow-1 ms-2">
