...
@section('script')
    ...
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-us-merc-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-in-mill-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-au-mill-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-us-il-chicago-mill-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-uk-mill-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-ca-lcc-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-europe-mill-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-fr-merc-en.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-es-merc.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery-jvectormap-es-mill.js') }}"></script>
    <!-- third party js ends -->
