                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-md img-thumbnail" alt="friend">
